...
{
	case 0:
		g.c = g._.u ({ control: 'passive', h: 0.15, hi: 'Подойди, есть дело', i: g.i.musicant, quest: true, story: ['Хочешь пройти в закрытую зону?', 'Знаю, все хотят', 'Могу организовать', 'Интересно? [q - no, e - es]', 'Для начала убеди меня', 'Что тебе можно доверять', 'Помоги местным и я помогу тебе', 'Меня все здесь знают как Музыкант', 'На этом все', 'Приходи, когда справишься', 'Приходи позже', 'Прекрати', 'Не доставай меня', 'Привет, я тебя знаю?', 'Полиция! Тут наркоман!', 'Хех, видел бы ты свою рожу', 'Давай уже', 'Я буду просто молчать', '', '', '', '', 'Настойчивый ублюдок', 'В этой игре есть и другие персонажи', 'Приходи позже'], type: 'npc', wk: 0.68, x: 0.29, xk: 0.5, y: 0.68, yk: 1, win: function() {g.q.musicant =1;}, z: 2, zen: true });
	break;
}
